...
public static class LinkedListTester {
    public static void Run() {
        ...
        Trace.Assert(ll.ToString() == "<LinkedList>{5, 4, 3, 2, 2, 2, 1}");
        ll.InsertTail(0);
        ll.InsertTail(-1);
        Console.WriteLine(ll.ToString()); // <LinkedList>{5, 4, 3, 2, 2, 2, 1, 0, -1};
        Trace.Assert(ll.ToString() == "<LinkedList>{5, 4, 3, 2, 2, 2, 1, 0, -1}");


        var ll2 = new LinkedList();
        ll2.InsertTail(1);
        Console.WriteLine(ll2.HeadAndTailAreNotNull()); // True
        Trace.Assert(ll2.HeadAndTailAreNotNull() == true);
        ...
        Trace.Assert(ll.ToString() == "<LinkedList>{5, 4, 3, 2, 2, 2, 1, 0}");
        ll.RemoveTail();
        Console.WriteLine(ll.ToString()); // <LinkedList>{5, 4, 3, 2, 2, 2, 1}
        Trace.Assert(ll.ToString() == "<LinkedList>{5, 4, 3, 2, 2, 2, 1}");
